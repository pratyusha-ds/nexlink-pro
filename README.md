...
| Technical Extension                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| This repository is a technical extension of my [**NexLink**](https://github.com/pratyusha-ds/nexlink) project, a collaborative web app I co-developed as a member of the **NexLink Team** during [**Chingu Voyage 59**](https://github.com/chingu-voyages/V59-tier3-team-31). <br><br> **Development Focus:** While the core application remains live and maintained by the team, this fork serves as a dedicated environment for implementing DevOps practices, including containerization with Docker. |

Current Extended Version:

Original Team Production: [**Nexlink »**](https://nexlink-dashboard.vercel.app)
...
1.  **Clone & Install:**
    ...
    Visit the repo here: [https://github.com/pratyusha-ds/nexlink-pro](https://github.com/pratyusha-ds/nexlink-pro)
...
2.  **Environment Variables:** Create a `.env.local` file and add:
    ...
    - `EMAIL_FROM`= NexLink Pro <onboarding@resend.dev>
...
The original project was envisioned and developed by the **Nexlink Team** as part of **Voyage 59** of the [**Chingu**](https://www.chingu.io/) Voyage.
